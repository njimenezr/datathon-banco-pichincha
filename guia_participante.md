# Guía del Participante — Datathon Grupo Pichincha · Equipo **Banco Pichincha**
...
| Empresa | Tu tabla |
|---|---|
| Banco | `banco.clean_room.clientes_banco` |

> **¿Qué significa cada columna y cada término?** Ten a mano tu
> [`diccionario.md`](diccionario.md). El esquema de **Deuna** y **Seguros** no está aquí:
> lo descubrirás **dentro del Clean Room** cuando ellas compartan sus tablas.
...
- En este datathon **tu equipo debe descubrir cómo crear el Clean Room** e invitar a las otras
  empresas (Deuna y Seguros) para cruzar por `id_cliente_hash` — eso es parte del reto.
...
- *"Cruza mi tabla con la de la otra empresa por id_cliente_hash y muéstrame los clientes sin seguro."*
- *"Entrena un modelo que prediga la propensión a contratar un producto usando mis señales financieras."*
